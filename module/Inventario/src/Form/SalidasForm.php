 ...
 * its constructor.
 */
class SalidasForm extends Form {
    ...
    public function __construct(Adapter $dbAdapter) {
        // Check input.
        // Define form name
        parent::__construct('salidas-form');
    ...
    protected function addElements() {
        ...
        $this->add([
            ...
            'options' => array(
                'label' => 'Concepto',
                'required' => true,
                'empty_option' => 'Concepto de Salida',
                'value_options' => array('Venta' => 'Venta','Credito' => 'Credito','Transpaso' => 'Transpaso'),
                'label_attributes' => array('class' => 'control-label')
            )
        ]);
